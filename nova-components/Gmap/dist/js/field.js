...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-gmap', __webpack_require__(5));
  Vue.component('detail-gmap', __webpack_require__(8));
  Vue.component('form-gmap', __webpack_require__(14));
});
...
var render = function() {
  ...
  return _c("span", [_vm._v(_vm._s(_vm.pos.lat) + " : " + _vm._s(_vm.pos.lng))])
}
var staticRenderFns = []
...
var update = __webpack_require__(2)("25a2aee6", content, false, {});
  ...
  return _c(
    ...
    [
      _c("template", { slot: "value" }, [
        _c("div", [
          _c("p", [_vm._v("Latitude: " + _vm._s(_vm.pos.lat))]),
          _vm._v(" "),
          _c("p", [_vm._v("Longitude: " + _vm._s(_vm.pos.lng))]),
          _vm._v(" "),
          _c("div", {
            directives: [
              {
                name: "show",
                rawName: "v-show",
                value: _vm.pos.lng != 0 || _vm.pos.lat != 0,
                expression: "pos.lng != 0 || pos.lat != 0"
              }
            ],
            ref: "map",
            staticClass: "gmap-size mt-4"
          })
        ])
      ])
    ],
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("61ca5373", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    watch: {
        pos: {
            handler: function handler(newValue, oldValue) {
                ...
                if ((this.pos.lat == 0 || isNaN(this.pos.lat)) && (this.pos.lng == 0 || isNaN(this.pos.lng))) {
    ...
    methods: {
        ...
        setInitialValue: function setInitialValue() {
            if (this.field.value) {
                var value = JSON.parse(this.field.value);
                if (value.lat == null) {
                    value.lat = 0;
                }
                if (value.lng == null) {
        ...
        markerUpdate: function markerUpdate() {
    ...
    [
      _c("template", { slot: "field" }, [
        _c("input", {
          ...
          staticClass:
            "input form-control form-input form-input-bordered w-full",
          attrs: { type: "number", max: "90", min: "-90", label: "Latitude" },
          domProps: { value: _vm.pos.lat },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.$set(_vm.pos, "lat", _vm._n($event.target.value))
            },
            blur: function($event) {
        ...
        _c("input", {
          ...
          staticClass:
            "input form-control form-input form-input-bordered w-full mt-2",
          attrs: {
            type: "number",
            max: "180",
            min: "-180",
          ...
          domProps: { value: _vm.pos.lng },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.$set(_vm.pos, "lng", _vm._n($event.target.value))
            },
            blur: function($event) {
              return _vm.$forceUpdate()
            }
        ...
        _vm._v(" "),
        _c("div", { ref: "map", staticClass: "gmap-size mt-4" })
      ])
    ],
    2
  )
